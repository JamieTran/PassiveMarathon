...
class HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Lazy Olympics",
            style: TextStyle(color: Constants.salmon_eggshell)),
      ...
      body: new GridView.count(
        ...
        children: <Widget>[
          new NavButton(
              ...
              Constants.bright_white,
              Constants.bright_white,
              "Marathons",
              Icons.directions_run,
              MaterialPageRoute(builder: (context) => GroupsScreen())),
          new NavButton(
              Constants.bright_blue,
              Constants.bright_white,
              Constants.bright_white,
              "Friends",
              Icons.group,
          ...
          new NavButton(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      ProfilePage(Constants.dbManagement.getUserRef()))),
          new NavButton(
